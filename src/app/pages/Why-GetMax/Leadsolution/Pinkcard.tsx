...
const Pinkcard = (props : any) => {
    return (
      <div className=" w-[140px] h-[2px] flex flex-row  justify-end text-left text-[14.6px] text-white font-source-sans-pro ">
        <div className="w-[140px] h-[215px] flex flex-col items-center justify-start">
          <img
            ...
            src={props.imgsource}
          />
          <div className="w-[140px] relative rounded-3xl h-[215px] mt-[-215px]" />
        </div>
