   ...
   <div className='grid grid-cols-3 gap-4 h-screen w-screen'>
      <div className='mx-20 my-32 p-5 shadow-2xl rounded-md'>
        <div className='grid grid-rows-3 gap-8'>
           <div className='py-5'>
             <h2 className='text-center font-medium text-2xl'>Medical Billings</h2>
           </div>
           ...
           <div className='grid py-9 px-14'>
            <button className='bg-red-400 text-white rounded-md font-semibold text-center'>ONLY 4 BENEFITS!</button>
           </div>
        </div>
      </div>
      <div className='grid'>
      <div className='mx-20 bg-purple-100 h-fit p-5 shadow-2xl rounded-md'>
        <div className='flex flex-col items-center justify-center gap-2'>
           <div className='py-5'>
             <h2 className='text-center font-semibold text-2xl text-custom-purple'>Medical Billings</h2>
           </div>
      ...
      <div className='mx-20 my-32 p-5 shadow-2xl rounded-md'>
        <div className='grid grid-rows-3 gap-8'>
           ...
           <div className='grid py-9 px-14'>
            <button className='bg-red-400 text-white rounded-md font-semibold text-center'>CHECK ERRORS!</button>
           </div>
        </div>
      </div>
      </div>
