...
const Statistics = () => {
  return (
    <div className="w-screen bg-gmd-purple h-screen overflow-hidden text-center  flex flex-col items-center justify-center text-17xl text-blueviolet font-sans ">
    <div className="  w-96 h-48 flex flex-col items-center text-4xl text-black font-red-hat-display">
      <b className="w-64 relative tracking-widest m-2 leading-relaxed capitalize h-12">
        WHY CHOOSE US
      </b>
      <div className="w-96 h-48vflex flex-col  justify-center py-[0.23239898681640625px] pr-0 pl-[0.04388456046581268px] box-border gap-8 mt-[-5px] text-29xl font-source-sans-pro">
