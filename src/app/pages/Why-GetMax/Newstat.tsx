...
const Newstat = () => {
  return (
    <div className='w-screen  text-black bg-[#F3EFFE] h-[650px] pb-8'>
    <br />
    <br />
    <div className=" flex flex-col items-center justify-end text-4xl text-black font-red-hat-display space-y-[5px]">
      ...
      <div className="w-[377.4px] h-[112.5px] flex flex-col items-center justify-center py-[.25px]  box-border gap-[21px] mt-[-5px] text-[25px] font-source-sans-pro">
