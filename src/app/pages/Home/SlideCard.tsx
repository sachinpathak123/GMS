...
function SlideCard(props:any){
    return(
      <>
      <div className='px-14 py-12 flex items-center justify-center'>
      <div className='bg-white w-[22vw] h-[46vh] shadow-lg'>
       ...
       <motion.button className='text-light-pUrple font-normal py-2' whileHover={{
        marginRight:'10px',
       }}>Learn More</motion.button> <FaArrowRight size={20} className='text-light-pUrple my-4'/>
       </div>
       </div>
       </div>
       </div>
