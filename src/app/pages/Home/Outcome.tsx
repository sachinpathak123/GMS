  ...
  return (
    <div className='py-20'>
       ...
       <div className='grid grid-cols-3 gap-y-20 gap-x-11 px-24 py-20  justify-items-center   '>
           <Qualities imgsource= "help 100+.png" data="we help to transform performance of revenue cycle to deliver improved margins,increased cash flow" head="Help 100+  healthcare organisation"/>
