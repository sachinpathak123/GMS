...
const Reviewcard = (props : any) => {
  return (
    <div className='max-w-full h-full flex flex-col items-center justify-items-center text-center border rounded-[10px] border-purple-400 border-solid  border-opacity-90 shadow-2xl bg-white' >
