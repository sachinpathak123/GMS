...
const Final = () => {
  return (
    <div className='bg-terror h-screen max-w-screen '>
        ...
        <h1 className='font-inter text-center text-5xl font-semibold py-8'>RCM Services</h1>
        <p className='font-inter text-center text-xl font-thin'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti illum non voluptatum?</p>
      </div>
