    ...
    >
      <div>
          ...
          {links.map(({ id, link, link1, sublinks }) => {
            if (link !== "Resources" && link !== "RCM services") {
              ...
              return (
                ...
                >
                  <Link href={link1}>{link}</Link>
                  <ul className=" opacity-0 transition-opacity p-3 w-fit bg-purple-500 group-hover:opacity-100 absolute mt-5">
                    {sublinks?.map((sub, i) => (
                      <li
                        key={i}
              ...
              return (
                ...
                >
                  <Link href={link1}>{link}</Link>
                  <div className=" bg-purple-500 flex flex-row items-stretch justify-stretch h-48 -translate-x-1/3 absolute mt-5 opacity-0 group-hover:opacity-100 w-150">
        ...
        <img
          src="/contact.png"
          alt="Target Image"
          className="w-36 h-10 relative right-6 top-1"
        />
      </motion.div>
    </>
  );
