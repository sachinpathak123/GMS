...
function sidebar() {
    return (
        <div className="flex">
        <aside className="top-0 w-80 bg-gray-50 text-black py-2 sticky h-screen">
            <nav className="space-y-4">
                <Link className="block py-2 px-4 rounded transition duration-300 hover:text-purple-900 border-b border-black"
