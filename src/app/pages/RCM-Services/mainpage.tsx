...
function mainpage() {
    return (
        ...
        <div className="mx-24 px-24 py-32">
            <div className="grid grid-cols-2 gap-24 place-content-center">
              <div className="pb-12 flex flex-col gap-4 items-start justify-center">
                <div>
              ...
              <div className="px-24 pb-12">
                <img src="/description.png" alt="an image" className=" h-[30rem]" />
              </div>
            </div>
        </div>
        </>
